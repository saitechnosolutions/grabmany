    ...
    jcf.addModule({
        ...
        initStructure: function () {
            ...
            if (isFinite(this.maxValue)) {
                this.maxValue -=
                    (this.maxValue - this.minValue) % this.stepValue;
            }
        },
...
(function ($, $win) {
    ...
    Tabset.prototype = {
        ...
        setStartActiveIndex: function () {
            ...
            var $activeLink = $classTargets.filter(
        ...
        setActiveTab: function () {
            ...
            this.$tabLinks.each(function (i, link) {
                ...
                if (i !== self.activeTabIndex) {
                    ...
                    $tab.addClass(self.options.tabHiddenClass).removeClass(
                        self.options.activeClass
                    );
                } else {
                    $classTarget.addClass(self.options.activeClass);
                    $tab.removeClass(self.options.tabHiddenClass).addClass(
                        self.options.activeClass
                    );
                }
        ...
        switchTabs: function () {
            ...
            setTimeout(
                function () {
                    self.getClassTarget($prevLink).removeClass(
                        self.options.activeClass
                    );
                    ...
                    self.getClassTarget($nextLink).addClass(
                        self.options.activeClass
                    );
        ...
        destroy: function () {
            ...
            this.$tabLinks.off(".tabset").each(function () {
                ...
                self.getClassTarget($link).removeClass(
                    self.options.activeClass
                );
