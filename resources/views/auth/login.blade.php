...
.subscribeSecBlock{
    ...
    <section class="track-area pb-40">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12"> <div class="login-section">
            <div class="login-box">
                ...
                <div class="login-content">
                    <h4>Login Here</h4>
                    <p>Your personal data will be used to support your experience throughout this website.</p>
                </div>
                <form action="/login" method="POST">
                    ...
                    <div class="login-btn">
                        <button type="submit" class="btn-submit">Login Now <i class="fa fa-long-arrow-right"></i></button>
                    </div>
                </form>
            </div>
        </div></div>
