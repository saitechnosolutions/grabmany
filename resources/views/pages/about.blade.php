					...
					<div id="accordion" class="accordionList pt-lg-12">
						<div class="card mb-2">
							...
							<div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
								...
								<div class="card-body px-xl-5 py-0">
									<p class="mb-7">Every piece we create is made using <b>top-tier fabrics</b> and crafted
						...
						<div class="card mb-2">
							...
							<div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
								<div class="card-body px-xl-5 py-0">
									<p class="mb-7">Whether you're lounging at home, heading out with friends, or dressing
